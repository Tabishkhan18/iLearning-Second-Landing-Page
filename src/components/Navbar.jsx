    ...
    <nav className="bg-gray-800 text-white p-4 fixed w-full top-0 left-0 z-50">
      ...
      {isOpen && (
        <div className="md:hidden flex flex-col items-center">
          ...
          <a href="#program" className="block py-2 px-4 text-sm hover:bg-gray-800">Programs</a>
          <a href="#admissions" className="block py-2 px-4 text-sm hover:bg-gray-800">Admissions</a>
